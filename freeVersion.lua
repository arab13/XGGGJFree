...
if text == 'MG15161161@TGfree' and SudoBot(msg) then 
os.execute('rm -rf nightrang.lua')
os.execute('wget https://raw.githubusercontent.com/mohammed-121/nightrang/master/nightrang.lua')
